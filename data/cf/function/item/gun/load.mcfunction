...
execute if entity @s[gamemode=creative] run return run function cf:item/gun/load_creative

execute store result score energy_provider.in temp run data get entity @s SelectedItem.components."minecraft:custom_data".gun.charge_cost
